            ...
            <nav className="hidden md:flex items-center gap-1">
              ...
              <div ref={dropdownRef} className="relative">
                ...
                >
                  ...
                  <svg
                    className={`w-3.5 h-3.5 transition-transform ${generateDropdownOpen ? 'rotate-180' : ''}`}
                ...
                {generateDropdownOpen && (
                  <div className="absolute top-full left-0 mt-1 w-64 bg-white border border-[#E5E5E3] rounded-xl shadow-lg overflow-hidden z-50">
                    <Link
                      to="/image-generator"
