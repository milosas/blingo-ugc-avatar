  ...
  return (
    <div className="bg-white border border-[#E5E5E3] rounded-2xl overflow-hidden transition-all hover:border-[#D4D4D2]">
      ...
      >
        ...
        <svg
          className={`w-5 h-5 text-[#999999] transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`}
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
...
function StatCard({ icon, label, value, color }: StatCardProps) {
  ...
  return (
    <div className="bg-white border border-[#E5E5E3] rounded-xl p-4 hover:border-[#D4D4D2] hover:shadow-sm transition-all">
