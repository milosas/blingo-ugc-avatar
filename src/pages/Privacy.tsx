      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white shadow rounded-lg p-8">
          ...
          <div className="prose prose-indigo max-w-none">
            ...
            <h3 className="text-lg font-medium text-gray-800 mt-6 mb-3">2.2 Images and Content</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-lg font-medium text-gray-800 mt-6 mb-3">2.3 Automatically Collected Information</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">7. Guest Mode</h2>
            <p className="text-gray-700 mb-4">
              You can use Re Edit Me without creating an account. In guest mode:
            </p>
            <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
        ...
        <div className="mt-8 text-center text-gray-500 text-sm">
          Re Edit Me &copy; {new Date().getFullYear()}
        </div>
      </div>
    </div>
  );
